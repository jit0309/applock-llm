...
//    }
    ...
    fun formatTime(): String {
        ...
        val abs = kotlin.math.abs(total.toInt())
        ...
        return if (isNegative) "-$time" else time
    }


    fun formatSessionTime(): String {
        val isNegative = sessionTime < 0
        val abs = kotlin.math.abs(sessionTime.toInt())
    ...
    fun formatAvailableTime(): String {
        val isNegative = availabletime < 0
        val abs = kotlin.math.abs(availabletime.toInt())
