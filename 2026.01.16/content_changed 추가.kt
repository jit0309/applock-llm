...
//    private var isInHomeProtection = false
    ...
    private fun startUsageEventsMonitoring() {
        ...
        usageEventsMonitor?.startMonitoring(intervalMs = 30 * 1000L)
...
//            }
            ...
            // 📌 TYPE_WINDOW_STATE_CHANGED일 때만 노이즈 필터링
            if (event.eventType == AccessibilityEvent.TYPE_WINDOW_STATE_CHANGED) {
...
//            }
            ...
            // 활동 추적 업데이트 - TYPE_WINDOW_STATE_CHANGED일 때만 (실제 앱 전환)
            // TYPE_WINDOW_CONTENT_CHANGED는 백그라운드 앱에서도 발생할 수 있어서 제외
            if (event.eventType == AccessibilityEvent.TYPE_WINDOW_STATE_CHANGED &&
                packageName != lastActivePackage &&
